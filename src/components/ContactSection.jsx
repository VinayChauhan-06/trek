  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.message && error.message.includes('credentials not configured')) {
        errorMessage = 'EmailJS is not fully configured yet. Please check your .env file and ensure Service ID and Template ID are set. See EMAILJS_SETUP.md for instructions.'
      } else if (error.message && error.message.includes('Invalid')) {
        errorMessage = 'EmailJS configuration error. Please verify your Service ID, Template ID, and Public Key in the .env file.'
      } else {
        errorMessage += ' Please try again or contact us directly at vinaychauhan1352002@gmail.com'
      }
            ...
            >
              ...
              <div>
                ...
                <div className="flex gap-4">
                  ...
                  {/* Instagram */}
                  <a
                    href="https://www.instagram.com/remotetrek?igsh=Z2MwMGJzcGlpd2N3"
                    target="_blank"
                  ...
                  {/* YouTube */}
                  <a
                    href="https://youtube.com/@remotetrek?si=vtW3St89RNayu2qr"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full border-2 border-gray-300 flex items-center justify-center hover:border-himalaya-green hover:bg-himalaya-green transition-all duration-300 group"
                    aria-label="YouTube"
