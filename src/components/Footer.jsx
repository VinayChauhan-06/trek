        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            ...
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white">REMOTE TREK</h3>
          ...
          <div>
            ...
            <ul className="space-y-3 mb-8">
              <li>
                <Link to="/" className="text-sm hover:text-himalaya-green transition-colors duration-300">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/about-us" className="text-sm hover:text-himalaya-green transition-colors duration-300">
                  About us
                </Link>
              </li>
              <li>
                <Link to="/chardham" className="text-sm hover:text-himalaya-green transition-colors duration-300">
                  Chardham Yatra
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/blogs" className="text-sm hover:text-himalaya-green transition-colors duration-300">
                  Blogs
                </Link>
              </li>
              <li>
                <Link to="/cancellation-policy" className="text-sm hover:text-himalaya-green transition-colors duration-300">
                  Cancellation Policy
                </Link>
              </li>
            </ul>
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/remotetrek?igsh=Z2MwMGJzcGlpd2N3" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center hover:from-purple-600 hover:to-pink-600 transition-all duration-300">
              ...
              <a href="https://youtube.com/@remotetrek?si=vtW3St89RNayu2qr" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-red-600 rounded-full flex items-center justify-center hover:bg-red-700 transition-colors duration-300">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/trek-bali-pass-trek" className="text-sm hover:text-himalaya-green transition-colors duration-300">
                  Bali Pass Trek
                </Link>
              </li>
              <li>
                <Link to="/trek-chopta-trek" className="text-sm hover:text-himalaya-green transition-colors duration-300">
                  Chopta trek
                </Link>
              </li>
              <li>
                <Link to="/trek-dayara-bugyal" className="text-sm hover:text-himalaya-green transition-colors duration-300">
                  Dayara Bugyal
                </Link>
              </li>
              <li>
                <Link to="/trek-gaumukh-tapovan-trek" className="text-sm hover:text-himalaya-green transition-colors duration-300">
                  Gaumukh Tapovan Trek
                </Link>
              </li>
              <li>
                <Link to="/trek-kedarkantha-trek" className="text-sm hover:text-himalaya-green transition-colors duration-300">
                  Kedarkantha Trek
                </Link>
              </li>
              <li>
                <Link to="/explore-treks" className="text-sm hover:text-himalaya-green transition-colors duration-300">
                  Explore All Treks
                </Link>
              </li>
            </ul>
      ...
      <div className="border-t border-gray-700 bg-gray-900 py-4 px-4 md:px-8 lg:px-16">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="text-sm text-gray-400 text-center md:text-left">
            Copyright@2025 Remote Trek, All Right Reserved – Powered by{' '}
          ...
          <div className="flex items-center gap-4">
            {/* Additional Links */}
            <Link to="/cancellation-policy" className="text-sm text-gray-400 hover:text-himalaya-green transition-colors duration-300 hidden md:block">
