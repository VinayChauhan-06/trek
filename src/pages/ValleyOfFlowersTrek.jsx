...
const ValleyOfFlowersTrek = () => {
  ...
  const [expandedMonths, setExpandedMonths] = useState({ July: true })
  ...
  const itineraryData = [
    {
      ...
      description: "Start your journey early morning from Dehradun. Enjoy a scenic drive through Rishikesh, Devprayag, Rudraprayag to Govindghat. Overnight stay in a guesthouse at Govindghat with dinner included.",
      distance: "280 km",
      time: "9-10 hrs"
    },
    {
      ...
      description: "Begin your trek from Govindghat to Ghangaria. The trail follows the Pushpawati River through beautiful forests. Overnight stay at Ghangaria.",
      distance: "14 km",
      time: "6-7 hrs"
    },
    {
      ...
      description: "Early morning trek to Valley of Flowers. Explore the beautiful valley filled with colorful alpine flowers. Return to Ghangaria. Overnight stay at Ghangaria.",
      distance: "10 km",
      time: "6-7 hrs"
    },
    {
      ...
      description: "Trek to Hemkund Sahib, a sacred Sikh pilgrimage site. Enjoy the beautiful lake and stunning views. Return to Ghangaria. Overnight stay at Ghangaria.",
      distance: "12 km",
      time: "7-8 hrs"
    },
    {
      ...
      description: "Trek back to Govindghat. Celebrate the completion of your trek. Overnight stay at Govindghat.",
      distance: "14 km",
      time: "5-6 hrs"
    },
    {
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 w-full">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                Best Valley of Flowers Trek Package
              </h1>
              <p className="text-lg md:text-xl text-white mb-8 leading-relaxed">
                Experience the UNESCO World Heritage Site - Valley of Flowers with our expertly guided trek package. Walk through a carpet of colorful alpine flowers, pristine meadows & enjoy stunning views of snow-capped peaks. Best visited during monsoon! Book now for a magical adventure!
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-base text-gray-800 font-medium">14,400 ft</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <svg className="w-8 h-8 text-himalaya-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-base text-gray-800 font-medium">38 KM</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <svg className="w-8 h-8 text-himalaya-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-6 px-4 md:px-8 lg:px-16 bg-orange-500">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-2xl md:text-3xl font-bold text-white">
            Trek Price : ₹10500/- (Dehradun to Dehradun)
          </p>
        </div>
      </section>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Valley of Flowers Trek</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">14,400 Ft</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Monsoon</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">July | August | September</p>
                  </div>
                </div>
              </div>
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Govindghat</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">38 Km</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">UNESCO World Heritage Site with colorful alpine flowers</p>
                  </div>
                </div>
              </div>
            </div>
