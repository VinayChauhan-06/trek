...
const BaliPassTrek = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      await sendEmail(formData, {
        sourcePage: 'Bali Pass Trek Page',
        subject: `New Inquiry for Bali Pass Trek from ${formData.name}`
      })
  ...
  const itineraryData = [
    ...
    },
    {
      ...
      description: "Trek through dense forests and cross streams. The trail offers stunning views of the surrounding peaks. Overnight stay at Rainbasera.",
      distance: "9 km",
      time: "5-6 hrs"
    },
    {
      ...
      description: "Continue trekking through beautiful meadows and forests. Reach the stunning Ruinsara Tal lake. Overnight stay at Ruinsara Tal.",
      distance: "7 km",
      time: "4-5 hrs"
    },
    {
      day: 5,
      title: "Rest day at Ruinsara Tal",
      description: "Acclimatization day. Explore the beautiful Ruinsara Tal lake and surrounding areas. Rest and prepare for the challenging days ahead.",
      distance: "Rest Day"
    },
    {
      day: 6,
      title: "Ruinsara to Odari",
      description: "Trek to Odari, the base camp for Bali Pass. The trail becomes more challenging with steep ascents. Overnight stay at Odari.",
      distance: "6 km",
      time: "4-5 hrs"
    },
    {
      day: 7,
      title: "Odari to Bali Pass Summit to Lower Dhamni",
      description: "Early morning start for the summit attempt. Cross the challenging Bali Pass at 16,207 ft. Descend to Lower Dhamni. This is the most challenging day of the trek.",
      distance: "14 km",
      time: "10-12 hrs"
    },
    {
      day: 8,
      title: "Trek to Yamunotri & drive to Janki Chatti",
      description: "Trek down to Yamunotri temple. Visit the holy temple and take a dip in the hot springs. Drive to Janki Chatti. Overnight stay at Janki Chatti.",
      distance: "5 km trek & 3 km drive",
      time: "4-5 hrs"
    },
    {
      day: 9,
      title: "Drive back to Dehradun from Janki Chatti",
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 w-full">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                Best Bali Pass Trek Package
              </h1>
              <p className="text-lg md:text-xl text-white mb-8 leading-relaxed">
                Experience one of the most thrilling high-altitude adventures in Uttarakhand with our Bali Pass Trek Package. Walk through dense forests, scenic meadows & icy trails – all with expert guidance. Limited slots available. Book now to secure your slot!
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-base text-gray-800 font-medium">16,207 ft</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <svg className="w-8 h-8 text-himalaya-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-base text-gray-800 font-medium">57 KM</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <svg className="w-8 h-8 text-himalaya-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-6 px-4 md:px-8 lg:px-16 bg-orange-500">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-2xl md:text-3xl font-bold text-white">
            Trek Price : ₹16999/- (Dehradun to Dehradun)
          </p>
        </div>
      </section>
          ...
          <div className="bg-white border-2 border-orange-500 rounded-lg p-6 md:p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Bali Pass Trek</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">16,207 Ft</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">57 Km</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Cross over trail | Start in one valley, traverse the pass, and ends in another valley.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              ...
              <ul className="space-y-2 text-gray-700">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-himalaya-green font-bold">{'>>'}</span>
                  <span>Services: Sankri to Janki Chatti.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-himalaya-green font-bold">{'>>'}</span>
