  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      await sendEmail(formData, {
        sourcePage: 'Chopta Trek Page',
        subject: `New Inquiry for Chopta Trek from ${formData.name}`
      })
  ...
  const itineraryData = [
    {
      ...
      description: "Start your journey early morning from Rishikesh. Enjoy a scenic drive through Devprayag, Rudraprayag to Chopta. Check into the campsite. Overnight stay at Chopta with dinner included.",
      distance: "200 km",
      time: "7-8 hrs"
    },
    {
      ...
      description: "Early morning trek to Tungnath temple, the highest Shiva temple in the world. Continue to Chandrashila peak for panoramic views. Return to Chopta. Overnight stay at Chopta.",
      distance: "5 km",
      time: "4-5 hrs"
    },
    {
      ...
      description: "After breakfast, drive back to Rishikesh. The journey takes you through beautiful mountain roads. Arrive at Rishikesh by evening.",
      distance: "200 km",
      time: "7-8 hrs"
    }
  ]
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 w-full">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                Best Chopta Trek Package
              </h1>
              <p className="text-lg md:text-xl text-white mb-8 leading-relaxed">
                Experience the beautiful Chopta region, known as the 'Mini Switzerland of India' with our expertly guided trek package. Perfect for beginners, this trek offers stunning views of snow-capped peaks, lush meadows & pristine forests. Book now for a memorable winter adventure!
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-base text-gray-800 font-medium">2 Night - 3 Days</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <svg className="w-8 h-8 text-himalaya-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-base text-gray-800 font-medium">8,500 ft</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <svg className="w-8 h-8 text-himalaya-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-base text-gray-800 font-medium">12 KM</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <svg className="w-8 h-8 text-himalaya-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-base text-gray-800 font-medium">Easy: Level 1</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white border-2 border-orange-500 rounded-lg p-6 md:p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Chopta Trek</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">8,500 Ft</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Chopta</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Rishikesh</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">12 Km</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Jolly Grant Airport, which is 20 km away from Rishikesh</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Easy trek to temple and peak with stunning views</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              ...
              <ul className="space-y-2 text-gray-700">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-himalaya-green font-bold">{'>>'}</span>
                  <span>Services: Rishikesh to Rishikesh.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-himalaya-green font-bold">{'>>'}</span>
                  <span>Meeting Point: Pickup/Drop Point: Rishikesh Bus Stand</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-himalaya-green font-bold">{'>>'}</span>
