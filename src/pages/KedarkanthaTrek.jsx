...
const KedarkanthaTrek = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      await sendEmail(formData, {
        sourcePage: 'Kedarkantha Trek Page',
        subject: `New Inquiry for Kedarkantha Trek from ${formData.name}`
      })
  ...
  const itineraryData = [
    ...
    },
    {
      ...
      description: "Begin your trek from Sankri to Juda Ka Talab. The trail passes through beautiful pine forests and snow-covered paths. Overnight stay at Juda Ka Talab.",
      distance: "4 km",
      time: "3-4 hrs"
    },
    {
      ...
      description: "Trek to Kedarkantha Base Camp. The trail offers stunning views of snow-covered peaks. Overnight stay at base camp.",
      distance: "3 km",
      time: "3-4 hrs"
    },
    {
      day: 4,
      title: "Kedarkantha Base Camp to Summit and back to Hargaon",
      description: "Early morning summit attempt to Kedarkantha peak. Enjoy 360-degree views of the Himalayas. Descend to Hargaon. Overnight stay at Hargaon.",
      distance: "8 km",
      time: "7-8 hrs"
    },
    {
      ...
      description: "Trek back to Sankri and drive to Dehradun. Celebrate the completion of your trek. Arrive at Dehradun by evening.",
      distance: "5 km trek & 190 km drive",
      time: "8-9 hrs"
    }
  ]
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 w-full">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                Best Kedarkantha Trek Package
              </h1>
              <p className="text-lg md:text-xl text-white mb-8 leading-relaxed">
                Experience one of the most popular winter treks in India with our expertly guided Kedarkantha trek package. Walk through snow-covered trails, dense pine forests & enjoy 360-degree views from the summit. Perfect for beginners! Book now for an unforgettable winter adventure!
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-base text-gray-800 font-medium">4 Night - 5 Days</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <svg className="w-8 h-8 text-himalaya-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-base text-gray-800 font-medium">12,500 ft</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <svg className="w-8 h-8 text-himalaya-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-base text-gray-800 font-medium">20 KM</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <svg className="w-8 h-8 text-himalaya-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Kedarkantha Trek</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">12,500 Ft</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">20 Km</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Snow trek with 360-degree summit views</p>
                  </div>
                </div>
              </div>
            </div>
