  ...
  const itineraryData = [
    {
      ...
      description: "Start your journey early morning from Dehradun. Enjoy a scenic drive through Mussoorie, Uttarkashi to Barsu. Overnight stay in a guesthouse at Barsu with dinner included.",
      distance: "200 km",
      time: "8-9 hrs"
    },
    {
      ...
      description: "Begin your trek from Barsu to Barnala. The trail passes through beautiful forests and offers stunning views. Overnight stay at Barnala.",
      distance: "5 km",
      time: "4-5 hrs"
    },
    {
      day: 3,
      title: "Barnala to Dayara Bugyal",
      description: "Trek to the beautiful Dayara Bugyal meadows. The vast alpine meadows offer breathtaking views of snow-capped peaks. Overnight stay at Dayara Bugyal.",
      distance: "6 km",
      time: "4-5 hrs"
    },
    {
      day: 4,
      title: "Explore Dayara Bugyal",
      description: "Spend the day exploring the vast Dayara Bugyal meadows. Enjoy panoramic views of the Himalayas. Overnight stay at Dayara Bugyal.",
      distance: "Rest Day"
    },
    {
      day: 5,
      title: "Dayara Bugyal to Barnala",
      description: "Retrace your steps back to Barnala through the same beautiful trail. Overnight stay at Barnala.",
      distance: "6 km",
      time: "4-5 hrs"
    },
    {
      ...
      description: "Trek back to Barsu and drive to Dehradun. Celebrate the completion of your trek. Arrive at Dehradun by evening.",
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 w-full">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                Best Dayara Bugyal Trek Package
              </h1>
              <p className="text-lg md:text-xl text-white mb-8 leading-relaxed">
                Experience one of the most beautiful alpine meadows in India with our expertly guided Dayara Bugyal trek package. Walk through vast meadows, dense forests & enjoy stunning views of snow-capped peaks. Perfect for winter trekking! Book now for an unforgettable adventure!
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-base text-gray-800 font-medium">5 Night - 6 Days</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <svg className="w-8 h-8 text-himalaya-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-base text-gray-800 font-medium">12,000 ft</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <svg className="w-8 h-8 text-himalaya-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-base text-gray-800 font-medium">28 KM</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <svg className="w-8 h-8 text-himalaya-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-6 px-4 md:px-8 lg:px-16 bg-orange-500">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-2xl md:text-3xl font-bold text-white">
            Trek Price : ₹6500/- (Dehradun to Dehradun)
          </p>
        </div>
      </section>
              ...
              <div className="bg-white rounded-lg shadow-md p-6 space-y-4">
                ...
                <form className="space-y-4">
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-600">
                    <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-himalaya-green focus:ring-himalaya-green" />
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Dayara Bugyal Trek</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">12,000 Ft</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Winter</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">December | January | February | March</p>
                  </div>
                </div>
              </div>
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Barsu</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">28 Km</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Alpine meadow trek with stunning panoramic views</p>
                  </div>
                </div>
              </div>
            </div>
