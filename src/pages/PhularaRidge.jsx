...
const PhularaRidge = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      await sendEmail(formData, {
        sourcePage: 'Phulara Ridge Page',
        subject: `New Inquiry for Phulara Ridge from ${formData.name}`
      })
  ...
  const itineraryData = [
    ...
    {
      day: 4,
      title: "Rainbasera to Phulara Ridge",
      description: "Ascend to the beautiful Phulara Ridge. Enjoy panoramic views of the Himalayas. Overnight stay at Phulara Ridge campsite.",
      distance: "6 km",
      time: "4-5 hrs"
    },
    {
      day: 5,
      title: "Phulara Ridge to Dev Thach",
      description: "Trek along the ridge with breathtaking views. Descend to Dev Thach through beautiful meadows. Overnight stay at Dev Thach.",
      distance: "7 km",
      time: "5-6 hrs"
    },
    {
      day: 6,
      title: "Dev Thach to Seema",
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 w-full">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                Best Phulara Ridge Trek Package
              </h1>
              <p className="text-lg md:text-xl text-white mb-8 leading-relaxed">
                Experience the stunning ridge walk of Phulara Ridge with our expertly guided trek package. Walk through alpine meadows, dense forests & enjoy panoramic Himalayan views. Book now for an unforgettable adventure!
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-base text-gray-800 font-medium">12,100 ft</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <svg className="w-8 h-8 text-himalaya-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-base text-gray-800 font-medium">56 KM</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <svg className="w-8 h-8 text-himalaya-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-6 px-4 md:px-8 lg:px-16 bg-orange-500">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-2xl md:text-3xl font-bold text-white">
            Trek Price : ₹12999/- (Dehradun to Dehradun)
          </p>
        </div>
      </section>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Phulara Ridge Trek</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">12,100 Ft</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">56 Km</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Ridge walk with stunning panoramic views</p>
                  </div>
                </div>
              </div>
            </div>
