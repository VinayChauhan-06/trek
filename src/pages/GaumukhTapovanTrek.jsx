  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      await sendEmail(formData, {
        sourcePage: 'Gaumukh Tapovan Trek Page',
        subject: `New Inquiry for Gaumukh Tapovan Trek from ${formData.name}`
      })
  ...
  const itineraryData = [
    {
      ...
      description: "Start your journey early morning from Dehradun. Enjoy a scenic drive through Rishikesh, Uttarkashi to Gangotri. Visit the Gangotri temple. Overnight stay in a guesthouse at Gangotri with dinner included.",
      distance: "250 km",
      time: "9-10 hrs"
    },
    {
      ...
      description: "Begin your trek from Gangotri to Chirbasa. The trail follows the Bhagirathi River through beautiful forests. Overnight stay at Chirbasa.",
      distance: "9 km",
      time: "4-5 hrs"
    },
    {
      day: 3,
      title: "Chirbasa to Bhojwassa",
      description: "Continue trekking along the river. The trail offers stunning views of the surrounding peaks. Overnight stay at Bhojwassa.",
      distance: "5 km",
      time: "3-4 hrs"
    },
    {
      day: 4,
      title: "Bhojwassa to Gaumukh and Tapovan",
      description: "Early morning trek to Gaumukh, the source of the Ganges. Continue to Tapovan meadows with breathtaking views of Mt. Shivling. Overnight stay at Tapovan.",
      distance: "8 km",
      time: "5-6 hrs"
    },
    {
      ...
      description: "Spend the day exploring Tapovan meadows. Enjoy panoramic views of the Himalayas including Mt. Shivling, Meru, and Bhagirathi peaks. Overnight stay at Tapovan.",
      distance: "Rest Day"
    },
    {
      day: 6,
      title: "Tapovan to Bhojwassa",
      description: "Retrace your steps back to Bhojwassa through the same beautiful trail. Overnight stay at Bhojwassa.",
      distance: "8 km",
      time: "4-5 hrs"
    },
    {
      day: 7,
      title: "Bhojwassa to Gangotri",
      description: "Trek back to Gangotri. Visit the temple and celebrate the completion of your trek. Overnight stay at Gangotri.",
      distance: "14 km",
      time: "6-7 hrs"
    },
    {
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 w-full">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                Best Gaumukh Tapovan Trek Package
              </h1>
              <p className="text-lg md:text-xl text-white mb-8 leading-relaxed">
                Experience the sacred source of the Ganges at Gaumukh and the stunning Tapovan meadows with our expertly guided trek package. Walk through glaciers, high-altitude meadows & enjoy breathtaking views of Mt. Shivling. Book now for a spiritual and adventurous journey!
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-base text-gray-800 font-medium">7 Night - 8 Days</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <svg className="w-8 h-8 text-himalaya-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-base text-gray-800 font-medium">14,600 ft</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <svg className="w-8 h-8 text-himalaya-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-base text-gray-800 font-medium">62 KM</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <svg className="w-8 h-8 text-himalaya-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-base text-gray-800 font-medium">Difficult: Level 3</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-6 px-4 md:px-8 lg:px-16 bg-orange-500">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-2xl md:text-3xl font-bold text-white">
            Trek Price : ₹16000/- (Dehradun to Dehradun)
          </p>
        </div>
      </section>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Gaumukh Tapovan Trek</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">14,600 Ft</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">May | June | September | October</p>
                  </div>
                </div>
              </div>
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Gangotri</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Difficult</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">62 Km</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-himalaya-green mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Glacier trek to the source of Ganges with high-altitude meadows</p>
                  </div>
                </div>
              </div>
            </div>
...
export default GaumukhTapovanTrek
